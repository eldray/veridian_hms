// src/components/settings/CompanySettingsTab.tsx
  ...
  return (
    <div className="space-y-6">
      <div className="bg-[var(--bg-card)] rounded-xl p-4 border border-[var(--border-color)]">
        <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">Hospital Information</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="w-20 h-20 bg-[var(--bg-main)] rounded-lg border-2 border-dashed border-[var(--border-color)] flex items-center justify-center overflow-hidden flex-shrink-0">
                {imagePreview ? (
                  <img
                    src={imagePreview}
                  ...
                  <Building className="w-6 h-6 text-[var(--text-tertiary)]" />
                )}
              </div>
