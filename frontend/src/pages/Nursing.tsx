// src/pages/Nursing.tsx - COMPLETE ENHANCED VERSION
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="p-2 text-[var(--text-secondary)] hover:text-teal-600 rounded-lg"
              title="View Details"
            >
                  ...
                  {Array.from({ length: remainingDoses }, (_, i) => {
                    ...
                    return (
                      <div key={`upcoming-${doseNum}`} className={`flex items-center gap-3 p-2 ${isCurrent ? 'bg-yellow-50 rounded-lg' : 'opacity-70'}`}>
                        ...
                        <div>
                          <p className={`text-sm ${isCurrent ? 'font-medium text-yellow-800' : 'text-[var(--text-secondary)]'}`}>
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)]">Medication administration, patient care, and shift handover</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={() => navigate('/dashboard/admissions')}
            className="flex items-center gap-2 px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg hover:bg-[var(--bg-main)] text-sm"
          >
      ...
      <div className="flex gap-6" style={{ minHeight: 'calc(100vh - 280px)' }}>
        ...
        <div className="w-80 flex-shrink-0 bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] overflow-hidden flex flex-col">
          ...
          <div className="divide-y divide-[var(--border-color)] flex-1 overflow-y-auto">
            {filteredAttendances.length === 0 ? (
              ...
              filteredAttendances.map(attendance => {
                ...
                const hasCriticalAlerts = false; // Would need to check vitals
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        ...
                        {hasCriticalAlerts && (
                          <div className="bg-red-100 text-red-600 text-xs font-medium px-2 py-0.5 rounded-full">
        ...
        <div className="flex-1 min-w-0">
          {selectedAttendance && selectedPatient ? (
            <>
              ...
              {/* Patient Summary Sidebar (Horizontal layout below header) */}
              ...
              {/* Tabs */}
              <div className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] overflow-hidden mt-4">
                <div className="border-b border-[var(--border-color)] px-4">
                  <div className="flex gap-6">
                    ...
                    <button onClick={() => setActiveTab('tasks')} className={`py-3 px-1 text-sm font-medium border-b-2 transition-all ${activeTab === 'tasks' ? 'border-teal-500 text-teal-600' : 'border-transparent text-[var(--text-secondary)]'}`}>
